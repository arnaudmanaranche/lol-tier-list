...
export function UrlDisplay(): ReactNode {
  ...
  return (
    <div className="w-full max-w-3xl rounded-lg bg-[#35363A] shadow-lg">
      ...
      <div className="flex items-center gap-2 bg-[#202124] px-4 py-2">
        <div className="flex flex-1 items-center rounded bg-[#35363A] px-3 py-1.5">
          ...
          <div className="flex flex-wrap items-center text-[#9AA0A6]">
        ...
        <div className="relative">
          <ArrowPathIcon
            ...
            onClick={cycleNames}
          />
          <span className="max-md:-translate-x-1/5 absolute -right-[82px] bottom-5 hidden translate-y-full -rotate-3 flex-nowrap items-center gap-0.5 whitespace-nowrap tracking-wide text-white max-md:bottom-1 md:flex lg:text-xl">
