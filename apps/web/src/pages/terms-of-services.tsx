        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 pb-5 leading-relaxed text-white md:px-6">
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              Welcome to LeagueTierList! These Terms of Use govern your access
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              ...
              (formerly Twitter). Account registration requires basic
              information provided through X. We reserve the right to suspend or
              terminate accounts under conditions to be determined.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl md:leading-[1.1] lg:leading-[1.125em]">
            ...
            <p className="max-w-4xl">
              ...
              Manaranche and may be reused for any purpose. While users can
              create tier lists, ownership of this content is retained by
              LeagueTierList. Users do not grant additional licenses or
              permissions for other content.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl md:leading-[1.1] lg:leading-[1.125em]">
            ...
            <p className="max-w-4xl">
              ...
              updates. We disclaim liability for any damages, including data
              loss or service interruptions, that may arise during the use of
              our website.
            </p>
          </div>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              These Terms of Use are governed by the laws of France. All
              disputes arising from the use of our website will be settled under
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              ...
              Users will be notified of significant changes via email from{' '}
