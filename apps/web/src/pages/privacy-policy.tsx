        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 pb-5 leading-relaxed text-white md:px-6">
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              ...
              . By accessing our website, you agree to the terms outlined in
              this policy.
            </p>
          </div>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              Your data is collected through cookies, which are used to store
              your access and refresh tokens for seamless website functionality.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl md:leading-[1.1] lg:leading-[1.125em]">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              We do not share your data with third parties except for Vercel,
              our hosting provider, which ensures the technical operation of our
              website.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              Your data is not transferred internationally and is stored
              securely within the operational regions of our hosting provider.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl md:leading-[1.1] lg:leading-[1.125em]">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-4xl">
              This website operates in compliance with applicable laws,
              including French and international privacy regulations.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl md:leading-[1.1] lg:leading-[1.125em]">
            ...
            <p className="max-w-4xl">
              We use cookies to maintain your connection by securely storing
              your access and refresh tokens. These cookies are essential for
              the operation of the website and cannot be opted out.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-3xl md:leading-[1.1] lg:leading-[1.125em]">
            ...
            <p className="max-w-4xl">
              ...
              recognize the importance of protecting minors&apos; privacy. If
              you believe we have collected data from a minor without proper
