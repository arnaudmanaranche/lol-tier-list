...
const PrivacyPolicy = (): ReactElement => (
  <div className="pt-10 m-auto prose lg:prose-xl dark:text-white">
    ...
    <ul>
      <li>
        <p>
          <strong className="dark:text-white">Account</strong> means a unique account created for
          You to access our Service or parts of our Service.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers
          to LoL Power Ranking.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Cookies</strong> are small files that are placed on
      ...
      <li>
        <p>
          <strong className="dark:text-white">Country</strong> refers to: France
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Device</strong> means any device that can access the
          Service such as a computer, a cellphone or a digital tablet.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Personal Data</strong> is any information that relates
          to an identified or identifiable individual.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Service</strong> refers to the Website.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Service Provider</strong> means any natural or legal
      ...
      <li>
        <p>
          <strong className="dark:text-white">Third-party Social Media Service</strong> refers to
          any website or any social network website through which a User can log in or create an
          account to use the Service.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">Usage Data</strong> refers to data collected
      ...
      <li>
        <p>
          <strong className="dark:text-white">Website</strong> refers to LoL Power Ranking,
          accessible from{' '}
          <a
            ...
            target="_blank"
          >
            https://lol-power-ranking.app
          </a>
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">You</strong> means the individual accessing or using
    ...
    <h3 className="dark:text-white">Information from Third-Party Social Media Services</h3>
    <p>
      The Company allows You to create an account and log in to use the Service through the
      following Third-party Social Media Service:
    </p>
    <ul>
      <li>Twitter</li>
    </ul>
    ...
    <h3 className="dark:text-white">Tracking Technologies and Cookies</h3>
    <p>
    ...
    <ul>
      <li>
        <strong className="dark:text-white">Cookies or Browser Cookies.</strong> A cookie is a small
    ...
    <ul>
      <li>
        <p>
          <strong className="dark:text-white">Necessary / Essential Cookies</strong>
        </p>
      ...
      <li>
        <p>
          <strong className="dark:text-white">Cookies Policy / Notice Acceptance Cookies</strong>
        </p>
      ...
      <li>
        <p>
          <strong className="dark:text-white">Functionality Cookies</strong>
        </p>
        <p>Type: Persistent Cookies</p>
        <p>Administered by: Us</p>
        <p>
    ...
    <ul>
      <li>
        <p>
          <strong className="dark:text-white">To provide and maintain our Service</strong>,
          including to monitor the usage of our Service.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">To manage Your Account:</strong> to manage Your
      ...
      <li>
        <p>
          <strong className="dark:text-white">For the performance of a contract:</strong> the
      ...
      <li>
        <p>
          <strong className="dark:text-white">To contact You:</strong> To contact You by email,
      ...
      <li>
        <p>
          <strong className="dark:text-white">To provide You</strong> with news, special offers and
      ...
      <li>
        <p>
          <strong className="dark:text-white">To manage Your requests:</strong> To attend and manage
          Your requests to Us.
        </p>
      </li>
      <li>
        <p>
          <strong className="dark:text-white">For business transfers:</strong> We may use Your
      ...
      <li>
        <p>
          <strong className="dark:text-white">For other purposes</strong>: We may use Your
    ...
    <ul>
      <li>
        <strong className="dark:text-white">With Service Providers:</strong> We may share Your
        personal information with Service Providers to monitor and analyze the use of our Service,
        to contact You.
      </li>
      <li>
        <strong className="dark:text-white">For business transfers:</strong> We may share or
      ...
      <li>
        <strong className="dark:text-white">With Affiliates:</strong> We may share Your information
      ...
      <li>
        <strong className="dark:text-white">With business partners:</strong> We may share Your
        information with Our business partners to offer You certain products, services or
        promotions.
      </li>
      <li>
        <strong className="dark:text-white">With other users:</strong> when You share personal
        information or otherwise interact in the public areas with other users, such information may
        be viewed by all users and may be publicly distributed outside. If You interact with other
        users or register through a Third-Party Social Media Service, Your contacts on the
      ...
      <li>
        <strong className="dark:text-white">With Your consent</strong>: We may disclose Your
        personal information for any other purpose with Your consent.
      </li>
    </ul>
    <h2 className="dark:text-white">Retention of Your Personal Data</h2>
    <p>
    ...
    <h2 className="dark:text-white">Transfer of Your Personal Data</h2>
    <p>
    ...
    <h2 className="dark:text-white">Disclosure of Your Personal Data</h2>
    ...
    <h2 className="dark:text-white">Security of Your Personal Data</h2>
    <p>
    ...
    <h2 className="dark:text-white">Links to Other Websites</h2>
    <p>
    ...
    <h2 className="dark:text-white">Changes to this Privacy Policy</h2>
    <p>
