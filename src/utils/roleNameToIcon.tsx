import { LINE_UP_ORDER } from 'providers/pandascore/pandaScoreTournamentRostersToInternalTeams'
import type { ReactNode } from 'react'

export function roleNameToIcon(role: string): ReactNode {
  switch (role) {
    case LINE_UP_ORDER[0]:
      return (
        <svg
